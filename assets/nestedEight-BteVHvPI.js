import{a as u,c as p,r as d,s as g}from"./bodyLock-DTHPdllp.js";/* empty css              */import{c as _}from"./changePage-BhxG9jDn.js";import{c as w,s as h}from"./setToken-BKHZUtKH.js";import{r as F,s as y}from"./requestLoader-DXcZzcqD.js";import{r as E}from"./mainLoader-vDGbj-O4.js";const t={profileForm:document.querySelector(".profileForm-form"),fieldList:document.querySelector(".profileForm-form-fields"),profilePhoto:document.querySelector(".profileForm-form__img-input")};function b(){t.OnePasswordEl=document.querySelector(".profileForm-form-fields__input_origin"),t.TwoPasswordEl=document.querySelector(".profileForm-form-fields__input_check")}function L(){t.OnePasswordEl.value===t.TwoPasswordEl.value?t.TwoPasswordEl.setCustomValidity(""):t.TwoPasswordEl.setCustomValidity("пароль не співпадає")}function P(e){return new URL(window.location.href).searchParams.get(e)}function c(){return P("redact")==="true"}function q(){t.fieldList.insertAdjacentHTML("beforeend",v()),document.querySelectorAll(".profileForm-form-fields__input").forEach(o=>{o.setAttribute("required","")})}function v(){return`<li class="profileForm-form-fields__item">
